...
bytes, fixed-power FSK, residual carrier phase/frequency offset and production-message recovery.
...
→ AGC → clipping → band-limiting → sample-clock mismatch → residual carrier frequency offset/drift
